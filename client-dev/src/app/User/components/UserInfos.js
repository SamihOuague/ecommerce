        ...
        <div className="user">
            ...
            <div className="user__container">
                <div className="user__container__orders">
                    <h2>Vos Commandes</h2>
                    <Resources path={`${process.env.REACT_APP_API_URL}${process.env.REACT_APP_ORDER}/user-orders`} render={(data) => {
                        if (data.loading) return <Spinner />
                        else if (!data.payload || data.payload.logged === false) {
                            logOut();
    ...
    return (
        <div className="popup">
            <div className="popup__container">
                ...
                {(getConfirm) &&
                    <Resources path={`${process.env.REACT_APP_API_URL}${process.env.REACT_APP_AUTH}/confirm-email`} options={{
                        method: "GET",
                        headers: {
                            "Content-Type": "application/json",
                            "Authorization": `Barear ${localStorage.getItem("token")}`,
        ...
        <div className="popup">
            <form className="popup__container" onSubmit={(e) => handleDeleteProfil(e)}>
                ...
                <SubmitComponent
                    ...
                    path={`${process.env.REACT_APP_API_URL}${process.env.REACT_APP_AUTH}/delete-user`}
                    method="DELETE"
                    dataForm={dataForm}
                />
