            ...
            <div className="user__container">
                <form onSubmit={(e) => handleSubmit(e)} className="user__container__infos">
                    ...
                    <div className="user__container__infos__btngroup">
                        <SubmitComponent path={`${process.env.REACT_APP_API_URL}${process.env.REACT_APP_AUTH}/update-user`} method={"PUT"} dataForm={dataForm} btnValue={"Editer"} redirectTo={"/user"} />
