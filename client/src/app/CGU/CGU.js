...
function CGU() {
    return (
        <div className="CGU">
            <h1>Conditions générales d'utilisation du site www.palaisauxherbes.fr</h1>


            <h2>ARTICLE 1 : Objet</h2>

            <p>Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique de l'utilisation du site www.palaisauxherbes.fr et de ses services.</p>
            ...
            <p>Le site www.palaisauxherbes est édité par la société "Palais Aux Herbes", SARL au capital de 1000 €, dont le siège social est situé au 169 Rue de Paris, 91120 Palaiseau.</p>

            <p>La société est représentée par OUAGUENOUNI Farida.</p>


            <p>Pour les personnes physiques : </p>

            <p>Le site www.palaisauxherbes.fr est édité par OUAGUENOUNI Karim, domicilié au 2 Rue de Rome.</p>



            <h2>ARTICLE 3 : accès aux services</h2>

            <p>L'Utilisateur du site www.palaisauxherbes.fr a accès aux services suivants:</p>
                <ul>
                    <li>Liste des produits disponible en boutique.</li>
                    <li>Ajouter des produits dans un panier.</li>
                    <li>Cree un compte utilisateurs.</li>
                    <li>Commander et payer en ligne.</li>
                    <li>Faire une demande de contact.</li>
                </ul>
            ...
            <p>Les services suivants ne sont pas accessible pour l'Utilisateur que s'il est membre du site (c'est-à-dire qu'il est identifié à l'aide de ses identifiants de connexion) :</p>
            <ul>
                <li>Commander et payer en ligne.</li>
                <li>Editer son profil.</li>
                <li>Ajouter une critique (Note/5)</li>
            </ul>
            ...
            <p>L'Utilisateur assume l'entière responsabilité de l'utilisation qu'il fait des informations et contenus présents sur le site www.palaisauxherbes.fr.</p>
            ...
            <p>Le site www.palaisauxherbes.fr s'engage à mettre en œuvre tous les moyens nécessaires pour garantir la sécurité et la confidentialité des données. Toutefois, il n'apporte pas une garantie de sécurité totale.</p>
            ...
            <p>Certains contenus du site www.palaisauxherbes.fr (logos, textes, éléments graphiques, vidéos, etc.) sont protégés par le droit d'auteur, en vertu du Code de la propriété intellectuelle.</p>
            ...
            <p>L'adresse électronique(e - mail) de l'utilisateur pourra notamment être utilisée par le site www.palaisauxherbes.fr pour la communication d'informations diverses et la gestion du compte.</p>

            <p>www.palaisauxherbes.fr garantie le respect de la vie privée de l'utilisateur, conformément à la loi n°78 - 17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés.</p>
            ...
            <ul>
                ...
                <li>Par mail à contact@palaisauxherbes.fr</li>
                <li>Par voie postale au 169 Rue de Paris, 91120 Palaiseau.</li>
            </ul>
            ...
            <p>En cas de litige non résolu à l'amiable entre l'Utilisateur et l'Éditeur, les tribunaux de Palaiseau sont compétents pour régler le contentieux.</p>
        </div>
    );
};
